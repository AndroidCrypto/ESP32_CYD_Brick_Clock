/*
  This sketch displays a clock with 'Brick' clock face on the 320*240 display
  of the ESP32-CYD 2.8 inch TFT display.

  The face is stored as '.h' file in PROGMEM.

  The time is from an NTP server with Time Zone correction.

  The Clock face images are taken from https://github.com/aly-fly/EleksTubeHAX
  see folder: data - other graphics | 8 lego
  BMPs are 24 Color Depth
*/
...
const char* PROGRAM_VERSION = "ESP32 CYD Brick Clock V02";
const char* PROGRAM_TITLE = "ESP32 CYD Brick Clock";
...
/*
https://github.com/aly-fly/EleksTubeHAX | data - other graphics | 8 lego
EleksTubeHAX - An aftermarket custom firmware for the desk clock
converted with https://mischianti.org/rgb-image-to-byte-array-converter-for-arduino-tft-displays/
width 60 height 106
*/
